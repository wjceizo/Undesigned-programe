<template>
	<div class="fater-body-show">
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="cont" label="通知内容"></el-table-column>
		...
		<el-dialog title="添加信息" width="680px" :visible.sync="showAddFlag">
				...
				<el-row :gutter="15">
					<el-col :span="12">
						<el-form-item label="开始时间">
							<el-date-picker v-model="noticesForm.startTime" 
								value-format="yyyy-MM-dd" type="date" placeholder="选择开始展示日期"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="结束时间">
							<el-date-picker v-model="noticesForm.endTime" 
								value-format="yyyy-MM-dd" type="date" placeholder="选择结束展示日期"></el-date-picker>
						</el-form-item>
					</el-col>
				</el-row>
				<el-form-item label="通知内容">
					<el-input v-model="noticesForm.cont" type="textarea"
						:rows="4" placeholder="请输入通知内容…" autocomplete="off"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="修改信息" width="680px" :visible.sync="showUpdFlag">
			<el-form label-width="90px" :model="noticesForm">
				<el-form-item label="通知标题">
					<el-input v-model="noticesForm.title" 
						placeholder="请输入通知标题…" autocomplete="off"></el-input>
	...
	export default {
		...
		methods: {
			...
			getPageInfo(pageIndex, pageSize) {
				...
				getPageNotices(pageIndex, pageSize).then(resp => {
			...
			addInfo() {
				...
				addNotice(this.noticesForm).then(resp => {
			...
			updInfo() {
				...
				updNotice(this.noticesForm).then(resp => {
